...
class ResultsSubmissionForm(forms.Form):
	...
	board1_homePlayerScore = forms.CharField(required = False)
	board2_homePlayerScore = forms.CharField(required = False)
	board3_homePlayerScore = forms.CharField(required = False)
	board4_homePlayerScore = forms.CharField(required = False)
	board5_homePlayerScore = forms.CharField(required = False)
	board6_homePlayerScore = forms.CharField(required = False)

	board1_awayPlayerScore = forms.CharField(required = False)
	board2_awayPlayerScore = forms.CharField(required = False)
	board3_awayPlayerScore = forms.CharField(required = False)
	board4_awayPlayerScore = forms.CharField(required = False)
	board5_awayPlayerScore = forms.CharField(required = False)
	board6_awayPlayerScore = forms.CharField(required = False)
