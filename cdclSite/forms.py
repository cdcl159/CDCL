...
class ResultsSubmissionForm(forms.Form):
	...
	board1_homePlayerScore = forms.FloatField(required = False)
	board2_homePlayerScore = forms.FloatField(required = False)
	board3_homePlayerScore = forms.FloatField(required = False)
	board4_homePlayerScore = forms.FloatField(required = False)
	board5_homePlayerScore = forms.FloatField(required = False)
	board6_homePlayerScore = forms.FloatField(required = False)

	board1_awayPlayerScore = forms.FloatField(required = False)
	board2_awayPlayerScore = forms.FloatField(required = False)
	board3_awayPlayerScore = forms.FloatField(required = False)
	board4_awayPlayerScore = forms.FloatField(required = False)
	board5_awayPlayerScore = forms.FloatField(required = False)
	board6_awayPlayerScore = forms.FloatField(required = False)
